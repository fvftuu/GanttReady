    ...
    private static List<(int predIdx, int succIdx, int lag)> GetIndustryRelationPlan(string projectCode, List<TaskItem> tasks)
    {
        ...
        else if (projectCode.StartsWith("SHIP-"))
        {
            plan = new()
            {
                ...
                (9, 16, 0),  (10, 16, 0),              // 型材采购→钢材预处理（跳过父任务SH-03.1）
                (16, 19, 0),                            // 数控切割→小组立焊接（跳过父任务SH-03.2）
                (19, 20, 0), (20, 23, 0), (23, 24, 0), (24, 25, 0),
        ...
        else if (projectCode.StartsWith("NEV-"))
        {
            plan = new()
            {
                (2, 3, 0),   (3, 5, 0),   (3, 9, 0),   (3, 10, 0),  (3, 12, 0),
                // 产品定义→电池·车身·内外饰·供应商（并行开始）
                (5, 6, 0),   (6, 7, 0),
                (5, 16, 0),  (9, 16, 0),                             // 电池·车身→骡车试制
                (12, 13, 0), (13, 14, 0),
        ...
        else if (projectCode.StartsWith("AIDC-"))
        {
            ...
            {
                (1, 2, 0),   (2, 4, 0),   (4, 5, 0),
                (5, 8, 0),   (5, 10, 0),                         // 外墙→高压配电·暖通液冷（跳过父任务AI-03/AI-03.1）
                (8, 9, 0),                                        // 高压配电→低压配电+UPS
                (9, 13, 10), (10, 13, 0), (11, 13, 0),            // UPS·暖通·弱电→机柜安装（跳过父任务AI-04）
                (13, 14, 0), (14, 15, 0),
                (9, 17, 0),  (15, 17, 0),                         // UPS·网络→系统联调（跳过父任务AI-05）
                (17, 18, 0), (18, 19, 0),
            };
        }
