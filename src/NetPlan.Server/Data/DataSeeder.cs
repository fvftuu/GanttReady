    ...
    public static void SeedDemoData(NetPlanDbContext db)
    {
        ...
        var tasks = new List<TaskItem>
        {
            ...
            new()
            {
                ...
                PlanStartDate = startDate, PlanEndDate = startDate.AddDays(29), PlanDuration = 30,
                ActualStartDate = startDate, ActualEndDate = startDate.AddDays(29), ActualDuration = 30,
