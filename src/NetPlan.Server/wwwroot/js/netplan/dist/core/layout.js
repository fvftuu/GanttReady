                        ...
                        Object.keys(sameRow).forEach(function (rk) {
                            if (sameRow[rk].indexOf(next) !== -1) {
                                sameRow[rk].forEach(function (sib) {
                                    if (layers[sib] !== undefined && layers[sib] > maxLayer)
                                        maxLayer = layers[sib];
                                });
                            }
                        });
