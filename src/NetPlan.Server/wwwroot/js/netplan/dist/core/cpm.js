 ...
 */
export function calculateTimeParams(tasks, relations) {
    ...
    var events = {};
    var allTimeOffsets = [];
    Object.keys(starts).forEach(function (t) { if (allTimeOffsets.indexOf(t) === -1)
        allTimeOffsets.push(t); });
    Object.keys(ends).forEach(function (t) { if (allTimeOffsets.indexOf(t) === -1)
        allTimeOffsets.push(t); });
    // 按数值排序
 ...
 */
export function applySingleStartEnd(data) {
